...
5. `docs/03-顾客端功能.md` — 顾客端详细功能
6. `docs/04-商户后台功能.md` — 商户端详细功能
7. `docs/05-注册登录.md` — 认证流程
8. `docs/06-数据模型.md` — 数据结构
9. `docs/07-技术方案.md` — 开发方案
10. `docs/09-关键交互流程.md` — 关键场景
11. `docs/02-用户角色与权限.md` — 权限模型
12. `docs/10-设计原则.md` — 设计哲学
